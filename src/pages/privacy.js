      ...
      <section id="content" className="main">
        ...
        <h3>Cookies used in this website</h3>
          ...
          <tr><th>COOKIE</th><th>TYPE</th><th>DURATION</th><th>DESCRIPTION</th></tr>
	        ...
	        <tr>
            <td>gatsby-plugin-google-analytics-gdpr_cookies-enabled, cookies-accepted</td>
            <td>Essential</td>
            <td>1 year</td>
            <td>These cookies help us remember that you have seen the cookie message required by law.</td>
          </tr>
	      </table>
        ...
        <p>
          This cookie policy does not cover the links within this site linking to other websites.
